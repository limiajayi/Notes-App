...
const AddEditNotes = ({ noteData, type, onClose }) => {
    ...
    const handleAddNotes = () => {
        ...
        //if content is empty, show an error message
        if (!content) {
    ...
    return (
        <div className="relative">
            ...
            <div className="flex flex-col gap-2">
                    ...
                    {/* for input to be a controlled element
                    we must add a value and onchange attribute
                    here the function body destructures the event object */}
